...
const services = [
  {
    ...
    title: 'Zirai İlaçlar',
    description:
      'Fungisit, herbisit ve insektisit ürünleriyle bitki sağlığını koruyan çevre dostu çözümler.',
  ...
  },
  {
    ...
    description:
      'Klasik, sıvı ve mikro element gübrelerle toprak verimliliğini artıran özel formülasyonlar.',
  ...
  },
  {
    ...
    title: 'Tohum & Aşılama',
    description:
      'Sebze ve tarla ürünlerine özel, yüksek çimlenme oranına sahip kaliteli tohum seçkisi.',
  ...
  },
  {
    ...
    description:
      'Su tasarrufu sağlayan, verim arttıran modern damla sulama teknolojisi çözümleri.',
  ...
  },
  {
    ...
    description:
      'Uzman ekibimizle tarım planlama, ürün seçimi ve yönetim konularında profesyonel rehberlik.',
  ...
  },
  {
    ...
    description:
      'Doğal ve organik sertifikalı ürünlerle sürdürülebilir tarım için çevre dostu çözümler.',
    ...
    >
      ...
      >
        <div className="mb-4 w-12 h-12 bg-white group-hover:bg-gradient-to-br group-hover:from-[#1a4d2e] group-hover:to-[#2d5a3d] rounded-xl flex items-center justify-center transition-all duration-150 ease-in-out group-hover:rotate-12">
          <Icon
            size={24}
            className="text-gray-900 group-hover:text-white transition-colors duration-300 ease-in-out"
          />
        </div>
...
export default function Services() {
  // gerçek loop için 2 set yeterli
    ...
    <section id="services" className="section-padding bg-white overflow-hidden">
      ...
      <div className="relative">
        ...
        <div className="overflow-hidden">
          <div className="flex gap-6 md:gap-8 px-4 marquee-track">
